...
declare -a PARAM_MIN_TO_BUY=("0" "0.5")
declare -a PARAM_MIN_TO_SELL=("0" "0.5")
declare -a PARAM_DISCARD_DIV=("0" "10")
declare -a PARAM_DAYS_TO_DISCARD=("5" "30")
declare -a PARAM_MIN_DAYS_TO_BEGIN=("0")
declare -a PARAM_MAX_MONEY_TO_INVEST=("1" "10")
